...
class PartnerCompany(Base, UUIDMixin, TimestampMixin):
    ...
    regulatory_authority: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    regulatory_license_number: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    regulatory_license_document_url: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
