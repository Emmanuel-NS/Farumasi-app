    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-farumasi-700 via-farumasi-600 to-farumasi-500 p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-white/70 text-sm mt-1 font-medium">Doctor Portal</p>
        </div>

        <div className="bg-white rounded-3xl shadow-2xl p-7">
          <h2 className="text-xl font-extrabold text-slate-900 mb-1">Welcome, Doctor</h2>
          <p className="text-slate-500 text-sm mb-6">Sign in to manage your patients and prescriptions</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="doctor@farumasi.com"
          ...
          <p className="mt-5 text-center text-xs text-slate-500">
            Demo: <span className="font-mono text-slate-600">doctor@farumasi.com / Doctor@12345</span>
          </p>
        </div>
      </div>
    </div>
