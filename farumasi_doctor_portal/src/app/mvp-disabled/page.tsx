  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-slate-50 px-6">
      <div className="max-w-md text-center space-y-4">
        ...
        <h1 className="text-2xl font-bold text-slate-900">Doctor portal not in this release</h1>
        <p className="text-sm text-slate-600">
          The doctor portal is still under development and is excluded from the current MVP deployment.
