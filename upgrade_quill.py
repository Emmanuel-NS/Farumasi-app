...
text = text.replace("_contentController.dispose();", "")
...
# _buildEditorContent return type because it needs to be constrained to handle expanded
text = text.replace('Widget _buildEditorContent() {', 'Widget _buildEditorContent() {')
