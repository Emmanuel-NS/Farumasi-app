        ...
        <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <div className="space-y-1.5"><Label>Business Phone <span className="text-red-500">*</span></Label><Input placeholder="+250 788 000 000" /></div>
          ...
          {step === 3 && (
            <div className="space-y-4">
              <div className="space-y-1.5"><Label>Full Name <span className="text-red-500">*</span></Label><Input placeholder="Account administrator name" /></div>
              <div className="space-y-1.5"><Label>Email Address <span className="text-red-500">*</span></Label><Input type="email" placeholder="admin@pharmacy.rw" /></div>
              <div className="space-y-1.5"><Label>Password <span className="text-red-500">*</span></Label><Input type="password" placeholder="Min. 8 characters" /></div>
              <div className="space-y-1.5"><Label>Confirm Password <span className="text-red-500">*</span></Label><Input type="password" placeholder="••••••••" /></div>
