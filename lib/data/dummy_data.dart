...
final List<Medicine> dummyMedicines = [
  ...
  Medicine(
    ...
    description: 'Antibiotic used to treat bacterial infections. Requires a valid doctor\'s prescription.',
    price: 2500,
  ...
  Medicine(
    ...
    description: 'High-potency immune system booster to keep you healthy and energized.',
    price: 8000,
    imageUrl: 'https://images.unsplash.com/photo-1577018501255-6677f502c38d?auto=format&fit=crop&q=80&w=600',
    category: 'Vitamins',
    isPopular: true,
    rating: 4.9,
  ...
  Medicine(
    id: 'm4',
    name: 'Cough Syrup',
    description: 'Fast-acting relief from dry and chesty coughs. Cherry flavor.',
    price: 3500,
    imageUrl: 'https://images.unsplash.com/photo-1624454002302-36b824d7bd0a?auto=format&fit=crop&q=80&w=600',
    category: 'Cold & Flu',
    rating: 4.2,
  ...
  Medicine(
    ...
    description: 'Non-steroidal anti-inflammatory drug (NSAID) for pain relief and inflammation.',
    price: 1500,
    imageUrl: 'https://images.unsplash.com/photo-1550572017-ed108420b982?auto=format&fit=crop&q=80&w=600',
    category: 'Pain Relief',
    isPopular: true,
    rating: 4.7,
  ...
  Medicine(
    id: 'm6',
    name: 'Aloe Vera Gel',
    description: 'Pure soothing gel for sunburns, skin irritations, and daily moisturizing.',
    price: 6000,
    imageUrl: 'https://images.unsplash.com/photo-1596547610928-8547ae07106b?auto=format&fit=crop&q=80&w=600',
    category: 'Skincare',
    rating: 4.6,
  ...
  Medicine(
    ...
    price: 12000,
    imageUrl: 'https://images.unsplash.com/photo-1550572017-4fcdbb563725?auto=format&fit=crop&q=80&w=600',
    category: 'Vitamins',
    isPopular: true,
    rating: 4.9,
  ...
  Medicine(
    id: 'm8',
    name: 'Hand Sanitizer',
    description: 'Alcohol-based hand sanitizer that kills 99.9% of germs instantly.',
    price: 2000,
    imageUrl: 'https://images.unsplash.com/photo-1584483766114-2cea6fac257d?auto=format&fit=crop&q=80&w=600',
    category: 'Hygiene',
    rating: 4.5,
  ...
  Medicine(
    id: 'm9',
    name: 'Face Mask (N95)',
    description: 'High filtration respiratory protection. Comfortable fit for daily use.',
    price: 1000,
    imageUrl: 'https://images.unsplash.com/photo-1586942593568-29361efcd571?auto=format&fit=crop&q=80&w=600',
    category: 'Hygiene',
    isPopular: true,
    rating: 4.8,
  ...
  Medicine(
    ...
    price: 8500,
    imageUrl: 'https://images.unsplash.com/photo-1556228722-dca852a36b53?auto=format&fit=crop&q=80&w=600',
    category: 'Skincare',
    rating: 4.7,
  ...
  Medicine(
    ...
    price: 45000,
    imageUrl: 'https://images.unsplash.com/photo-1579722821273-0f6c7d44362f?auto=format&fit=crop&q=80&w=600',
    category: 'Nutrition',
    rating: 4.8,
  ...
  Medicine(
    ...
    price: 15000,
    imageUrl: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&q=80&w=600', // Reusing pill bottle
    category: 'Nutrition',
    rating: 4.7,
    isPopular: true,
  ...
  Medicine(
    ...
    price: 12000,
    imageUrl: 'https://images.unsplash.com/photo-1563189140-a6aed69ebad1?auto=format&fit=crop&q=80&w=600',
  ...
  Medicine(
    ...
    price: 18000,
    imageUrl: 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?auto=format&fit=crop&q=80&w=600', // abstract herbs
    category: 'Herbal Medicines',
    rating: 4.5,
  ...
  Medicine(
    ...
    price: 1500,
    imageUrl: 'https://images.unsplash.com/photo-1542614532-6a6c2057d2a3?auto=format&fit=crop&q=80&w=600',
  ...
  Medicine(
    ...
    price: 2500,
    imageUrl: 'https://images.unsplash.com/photo-1582719230166-5e5899479e0a?auto=format&fit=crop&q=80&w=600',
    category: 'Sexual Health',
    rating: 4.8,
  ...
  Medicine(
    ...
    description: 'Foldable standard wheelchair with comfortable seating. Durable frame.',
    price: 150000,
    imageUrl: 'https://images.unsplash.com/photo-1579737088463-3dc467d56a29?auto=format&fit=crop&q=80&w=600',
  ...
  Medicine(
    ...
    price: 15000,
    imageUrl: 'https://images.unsplash.com/photo-1583344933994-3a95832a8264?auto=format&fit=crop&q=80&w=600',
    category: 'Mobility Aids',
    rating: 4.6,
  ...
  Medicine(
    ...
    price: 18000,
    imageUrl: 'https://images.unsplash.com/photo-1563812423300-a4309b43e11b?auto=format&fit=crop&q=80&w=600',
  ...
  Medicine(
    ...
    price: 35000,
    imageUrl: 'https://images.unsplash.com/photo-1630656037492-f0275806c9bc?auto=format&fit=crop&q=80&w=600',
    category: 'Devices',
    rating: 4.7,
...
final List<HealthTip> dummyHealthTips = [
  HealthTip(
    ...
    content: 'Ginger is great for digestion and reducing nausea. It also has anti-inflammatory properties that can help with muscle pain.',
    imageUrl: 'https://images.unsplash.com/photo-1615485290382-441e4d049cb5?auto=format&fit=crop&q=80&w=600',
  ),
  HealthTip(
    id: 't2',
    title: 'Stay Hydrated',
    content: 'Drinking enough water is crucial for maintaining bodily functions, regulating temperature, and keeping your skin healthy.',
  ...
  HealthTip(
    ...
    content: 'Garlic supplements are known to boost the function of the immune system and can prevent common colds.',
    imageUrl: 'https://images.unsplash.com/photo-1615485925694-a0391632402a?auto=format&fit=crop&q=80&w=600',
  ),
];
