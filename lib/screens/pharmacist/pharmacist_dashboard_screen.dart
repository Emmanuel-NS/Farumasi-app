...
class _PharmacistDashboardScreenState extends State<PharmacistDashboardScreen> {
            ...
            children: [
              Text(
                ...
                style: const TextStyle(
                  ...
                  color: Color(0xFF1B5E20), // Deep Green header
                ),
              ),
              const SizedBox(height: 4),
              Text(
                "GreenCross Pharmacy", // Assessing Pharmacy Name
                style: TextStyle(
                  fontSize: 14, 
  ...
  void _handleAcceptRequest(PrescriptionOrder order) {
    // In a real app, this would open a dialog to select medicines and set price
    // For now, we simulate accepting.
    _service.reviewOrder(order, true);
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: const Text("Request Accepted! Moved to Orders."),
        backgroundColor: _primaryGreen,
      )
    );
  }
