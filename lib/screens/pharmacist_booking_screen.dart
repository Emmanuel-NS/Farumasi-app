  ...
  Widget _buildDayCell(DateTime day, bool isSelected, {bool isToday = false}) {
    ...
    if (status == 'weekend') {
      ...
      if (isToday) {
        ...
        textColor = const Color(0xFF1E9E68);
      }
    }
    ...
    if (isSelected) {
      if (status == 'available' || status == 'busy') {
         bgColor = const Color(0xFF1E9E68);
          ...
          TableCalendar(
            ...
            calendarStyle: CalendarStyle(
              todayDecoration: BoxDecoration(
                color: const Color(0xFF1E9E68).withValues(alpha: 0.5),
                shape: BoxShape.circle,
              ),
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: isTaken 
                                  ...
                                  : (isSelected ? const Color(0xFF1E9E68) : Colors.white),
                                borderRadius: BorderRadius.circular(8),
                                border: Border.all(
                                  color: isTaken 
                                    ? Colors.grey.shade400 
                                    : (isSelected ? const Color(0xFF1E9E68) : Colors.grey.shade300),
                                ),
                              ),
                              child: Column(
                                children: [
