                    ...
                    children: [
                      ...
                      if (widget.pharmacy.isOpen)
                        Container(
                          ...
                          child: const Text("Open Now", style: TextStyle(color: const Color(0xFF1E9E68), fontWeight: FontWeight.bold, fontSize: 12)),
                        )
                      else
                        Container(
                          padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PharmacistListScreen(pharmacy: widget.pharmacy),
                        ),
                      );
                    },
                    child: Padding(
