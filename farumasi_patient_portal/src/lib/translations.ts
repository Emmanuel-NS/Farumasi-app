...
const translations: Record<LangCode, T> = {
  ...
  en: {
    ...
    cart_payment_subtitle: "MTN MoMo or card — cards via Pesapal",
    cart_momo_push: "MTN MoMo direct, or card via Pesapal",
  ...
  rw: {
    ...
    cart_payment_subtitle: "MTN MoMo cyangwa ikarita — ikarita binyuze muri Pesapal",
    cart_momo_push: "MTN MoMo direct, cyangwa ikarita binyuze muri Pesapal",
  ...
  fr: {
    ...
    cart_payment_subtitle: "MTN MoMo ou carte — carte via Pesapal",
    cart_momo_push: "MTN MoMo direct, ou carte via Pesapal",
  ...
  sw: {
    ...
    cart_payment_subtitle: "MTN MoMo au kadi — kadi kupitia Pesapal",
    cart_momo_push: "MTN MoMo direct, au kadi kupitia Pesapal",
