...
const translations: Record<LangCode, T> = {
  ...
  en: {
    ...
    store_pharmacies: "Pharmacies we work with",
  ...
  rw: {
    ...
    store_pharmacies: "Amaduka dukorana",
  ...
  fr: {
    ...
    store_pharmacies: "Pharmacies partenaires",
  ...
  sw: {
    ...
    store_pharmacies: "Maduka tunayofanya kazi nayo",
