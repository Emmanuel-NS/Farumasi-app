...
const translations: Record<LangCode, T> = {
  ...
  en: {
    ...
    cart_access_title: "Verification code",
    cart_access_pickup: "Show this code at the pharmacy to collect your medicines.",
    cart_access_delivery: "Give this code to the rider to verify and complete delivery.",
    cart_access_min: "You choose this code — minimum 4 characters.",
    cart_access_label: "Your code",
    cart_payment_subtitle: "Pay securely with Flutterwave",
    cart_momo_push: "MTN MoMo, Airtel, or card via Flutterwave",
    ...
    cart_momo_start: "Opening Flutterwave checkout…",
  ...
  rw: {
    ...
    cart_payment_subtitle: "Wishyura neza na Flutterwave",
    cart_momo_push: "MTN MoMo, Airtel, cyangwa ikarita binyuze muri Flutterwave",
    ...
    cart_momo_start: "Gufungura Flutterwave…",
  ...
  fr: {
    ...
    cart_payment_subtitle: "Payez en toute sécurité avec Flutterwave",
    cart_momo_push: "MTN MoMo, Airtel ou carte via Flutterwave",
    ...
    cart_momo_start: "Ouverture de Flutterwave…",
  ...
  sw: {
    ...
    cart_payment_subtitle: "Lipa kwa usalama na Flutterwave",
    cart_momo_push: "MTN MoMo, Airtel, au kadi kupitia Flutterwave",
    ...
    cart_momo_start: "Inafungua Flutterwave…",
