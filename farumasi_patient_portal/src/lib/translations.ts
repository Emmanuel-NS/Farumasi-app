...
const translations: Record<LangCode, T> = {
  ...
  en: {
    ...
    cart_payment_subtitle: "Pay securely with MTN MoMo or Pesapal",
    cart_momo_push: "MTN MoMo or card via Pesapal",
    ...
    cart_momo_start: "Starting payment…",
  ...
  rw: {
    ...
    cart_payment_subtitle: "Wishyura neza na MTN MoMo cyangwa Pesapal",
    cart_momo_push: "MTN MoMo cyangwa ikarita binyuze muri Pesapal",
    ...
    cart_momo_start: "Gutangiza ubwishyu…",
  ...
  fr: {
    ...
    cart_payment_subtitle: "Payez en toute sécurité avec MTN MoMo ou Pesapal",
    cart_momo_push: "MTN MoMo ou carte via Pesapal",
    ...
    cart_momo_start: "Démarrage du paiement…",
  ...
  sw: {
    ...
    cart_payment_subtitle: "Lipa kwa usalama na MTN MoMo au Pesapal",
    cart_momo_push: "MTN MoMo au kadi kupitia Pesapal",
    ...
    cart_momo_start: "Inaanza malipo…",
