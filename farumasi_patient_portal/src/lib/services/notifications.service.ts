...
const MOCK_NOTIFICATIONS: AppNotification[] = [
  ...
  { id: "n3", title: "Prescription reviewed", message: "Your prescription has been reviewed and approved.", isRead: false, time: new Date(Date.now() - 7200000).toISOString(), category: "prescription" },
