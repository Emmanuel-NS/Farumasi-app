...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: "/icons/appicon-192.png", sizes: "192x192", type: "image/png" },
      { url: "/icons/appicon-512.png", sizes: "512x512", type: "image/png" },
    ],
    apple: "/icons/appicon-192.png",
    shortcut: "/icons/appicon-192.png",
  },
};
